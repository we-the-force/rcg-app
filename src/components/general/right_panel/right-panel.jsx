    ...
    return (
        <Block className="right_panel_cont">
            <Block className="search_block">
                ...
                <Link className="weatherwidget-io" href="https://forecast7.com/es/25d44n100d97/saltillo/" dataLabel_1="SALTILLO" dataIcons="Climacons Animated" dataDays="3" dataTheme="pure" dataSuncolor="#ff0000">SALTILLO</Link>
