    ...
    return (
        <Block className="right_panel_cont">
            <Block className="search_block">
                ...
                <a class="weatherwidget-io" href="https://forecast7.com/es/25d44n100d97/saltillo/" data-label_1="SALTILLO" data-icons="Climacons Animated" data-days="3" data-theme="pure" data-suncolor="#ff0000">SALTILLO</a>
