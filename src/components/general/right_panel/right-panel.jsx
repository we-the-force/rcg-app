    ...
    return (
        <Block className="right_panel_cont">
            <Block className="search_block">
                ...
                <Link className="weatherwidget-io" href="https://forecast7.com/es/25d44n100d97/saltillo/" data-label_1="SALTILLO" data-theme="pure" data-suncolor="#ff0000" >SALTILLO</Link>
